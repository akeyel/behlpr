---
title: "Predicting grassland community changes in response to changes in climate and land management"
...
---
# Supporting analysis for Keyel et al. in prep
...
# Set up paths
in.path = "../../drafts/BE_data_paper/R_inputs/"  # Path for inputs for spatialdemography model
out.path = "../../drafts/BE_data_paper/R_outputs/" # Base path for outputs for spatialdemography model
...
dpath = "../../datasets/" # Base path for data sets
...
do.sdm.visualization = 1
sdm.pdf = sprintf("%ssdm_visualization.pdf", opath)
...
```{r echo=FALSE}
sprintf("Analysis years: %s - %s", start.year, end.year)
...
print("Save Point 1 reached; last updated 2015-12-12")
...
#do.descriptives(my.data, my.index, desc.path) #**# This is broken too.
...
## Species Distribution Model Analyses
```{r echo=FALSE}
### Run Species Distribution model
sdm.out = do.sdm(my.data, my.index, col.index, sdm.type, do.sdm.visualization, sdm.pdf, start.year, end.year)
...
## SpatialDemography Model Results (NEEDS FIXING)
```{r echo=FALSE}
